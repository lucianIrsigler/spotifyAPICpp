...
inline std::string generateAuthenticationURL(std::string scopes,std::string& spotifyClientID, std::string& spotifyRedirectURI) {
...
inline std::string executeSearchWebBrowser(std::string requestedURL) {
...
inline std::string getTempToken(std::string authURL) {
...
inline void setTokensValues(std::string& authenticityToken, std::string& spotifyRefreshToken,std::string& readBuffer,std::string& scopes) {
    ...
    writeTokensToFile(authenticityToken, spotifyRefreshToken);
}
